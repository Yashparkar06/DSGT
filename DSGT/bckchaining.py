...
# Enter the number of rules: 3
# Enter the consequent of rule 1: A
# Enter the antecedent of rule 1 (separated by spaces): B C
# Enter the consequent of rule 2: D
# Enter the antecedent of rule 2 (separated by spaces): A B
# Enter the consequent of rule 3: F
# Enter the antecedent of rule 3 (separated by spaces): Z K
# Enter the initial facts (separated by spaces): B C
# Enter the target fact to check: D
# The target 'D' can be derived from the initial facts.
